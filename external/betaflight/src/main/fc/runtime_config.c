...
const char *armingDisableFlagNames[] = {
  "NOGYRO", "FAILSAFE",  "RXLOSS",    "BADRX",     "BOXFAILSAFE", "RUNAWAY",
  "CRASH",  "THROTTLE",  "ANGLE",     "BOOTGRACE", "NOPREARM",    "LOAD",
  "CALIB",  "CLI",       "CMS",       "BST",       "MSP",         "PARALYZE",
  "GPS",    "RESCUE SW", "RPMFILTER", "ARMSWITCH",
};
...
uint16_t enableFlightMode(flightModeFlags_e mask) {
    ...
    if (flightModeFlags != oldVal) beeperConfirmationBeeps(1);
